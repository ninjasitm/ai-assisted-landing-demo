---
applyTo: "**/*"
description: "Logging standards and best practices for ai-assisted-landing-demo"
---
...
function initHeroSection() {
	console.info("[HeroSection]: Initialized");
	try {
		// ...
	} catch (error) {
		console.error("[HeroSection] [init]: Failed | error:", error.message);
	}
}

// Event handler logging
function handleFormSubmit(event) {
	console.info("[ContactForm] [submit]: Form submitted");
	try {
		// ...
	} catch (error) {
		console.error(
			"[ContactForm] [submit]: Submission failed | error:",
			error.message,
		);
	}
}
